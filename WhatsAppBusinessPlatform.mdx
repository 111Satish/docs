...
<Card
    icon="link"
    href="https://developers.facebook.com/docs/whatsapp/on-premises-api/get-started"
  >
WhatsApp On-Premises API
...
And this is what Reender9 OTP SDK majorly focusses on right now, to help developers build their own applications using this API. Render9 provides a smart layer of abstraction around this API, which helps developer to build application easily. Developers can easily build chat bots or integrate the SDK in their exisiting appplication using the robust infrastructure for sending and event listening for messages.
